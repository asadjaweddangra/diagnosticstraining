...
const links = [
  ...
  { href: "/learning-tools", label: "Learning Tools", icon: BookMarked },
  { href: "/flashcards", label: "Flashcards", icon: Layers },
  { href: "/quizzes", label: "Quizzes", icon: ClipboardCheck },
  { href: "/final-exam", label: "Final Exam", icon: GraduationCap },
  { href: "/simulations", label: "Simulations", icon: Flame },
  { href: "/search", label: "Search", icon: Search },
  { href: "/bookmarks", label: "Bookmarks", icon: Bookmark },
  { href: "/glossary", label: "Glossary", icon: BookOpen },
  { href: "/special-topics", label: "Special Topics", icon: Activity },
