    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          body: "You capture data; the clinician interprets. When in doubt, escalate instead of interpreting.",
          items: ["Acquire images/data and optimize quality", "Document technical quality and limitations", "Do not diagnose or reassure beyond your scope"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          title: "References",
          links: [
            { label: "CDC High-Level Disinfection", href: "https://www.cdc.gov/infectioncontrol/guidelines/disinfection/index.html" },
            { label: "AIUM ALARA overview", href: "https://www.aium.org/resources/viewPage.aspx?id=130" },
          ],
        },
      ],
    },
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          items: ["Skipping ID check under time pressure", "Not documenting limitations", "Using diagnostic phrasing"],
        },
      ],
    },
  },
  ...
  },
  {
    ...
    content: {
      sections: [
        ...
        {
          type: "list",
          title: "What beginners miss",
          items: ["IVC vs aorta: look for compressibility and pulsatility", "Gallbladder drifts with position—reposition to find it", "Kidney cortex should be brighter than medulla"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          type: "list",
          title: "Gel & Contact",
          body: "Warm gel improves patient comfort and contact; generous gel reduces rib artifact.",
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          type: "list",
          title: "Escalate",
          items: ["Severe RUQ pain on probe pressure", "Findings limited despite optimization—document clearly"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          items: ["Long and transverse each lobe", "Isthmus midline", "Survey for nodules; note vascularity (color)"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          items: ["Use in-plane for continuous needle visualization", "Shallow angle improves visualization but increases path length", "Always visualize tip before advancing"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          variant: "info",
          title: "Common fixes",
          items: ["Move up/down one interspace", "Increase contact/gel to reduce rib shadow", "Fine heel-toe to center LV"],
        },
      ],
    },
  },
    ...
    content: {
      sections: [
        ...
        },
        {
          type: "list",
          title: "Documentation",
          items: ["Note electrode placement (limb vs torso)", "Note artifacts if present", "Notify clinician immediately for dangerous rhythms"],
        },
      ],
    },
  },
